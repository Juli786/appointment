            ...
            <div id="slot-container" class="mb-2" >
                <div class="row m-1 slot-div slot_1"  style="border-style: outset;">
                    <div class="col-md-6 form-group {{ $errors->has('start_time') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="available_hr" name="available_hr_start_time[]" class="form-control datetime" value="{{ old('start_time', isset($appointment) ? $appointment->start_time : '') }}" required>
                    </div>
                    <div class="col-md-6  form-group {{ $errors->has('finish_time') ? 'has-error' : '' }}">
                        <label for="finish_time">Finish Time*</label>
                        <input type="text" id="finish_time" name="available_hr_finish_time[]" class="form-control datetime" value="{{ old('finish_time', isset($appointment) ? $appointment->finish_time : '') }}" required>
                    </div>
                </div>
                <hr>
            </div>
